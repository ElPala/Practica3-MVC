constmongoose = require('./mongodb-connection')
class DB{
...
class Test extends DB{
    constructor(){
        super();
        this.schema=newmongoose.Schema({name:{type:String,required:true}});
        this._model=mongoose.model('products',this.schema);
    }
    async getData(){
        return await  //COMPLETAR AQUÍ
    }
        //PRUEBA OTROSMÉTODOS PARA ACTUALIZAR, AÑADIR, EXISTE
}
let test=newTest();
(async()=>console.log(awaittest.getData()))()
module.exports=DB;